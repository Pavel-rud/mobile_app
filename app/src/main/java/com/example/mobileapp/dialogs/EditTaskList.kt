...
class EditTaskList: AppCompatDialogFragment() {
    private var _binding: EditTaskListDialogBinding? = null
    private val binding get() = _binding!!

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        _binding = EditTaskListDialogBinding.inflate(LayoutInflater.from(context))
        val builder = AlertDialog.Builder(requireActivity())

        builder.setTitle("Edit a task list")
